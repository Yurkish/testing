...
#ifdef USE_TD11
 #include "stm32l1xx_hal.h"
 #include "stm32l1xx_TD11.h"   // BSP for TD11. The Nucleo BSP is used at the moment, need to build it for TD11
 #include "stm32l1xx_hal_conf.h" // ok
 #include "stm32l1xx_hw_conf.h" // need to check
#endif
