...
#define RADIO_ANT_SWITCH_PIN                      GPIO_PIN_4 // GPIOA_4 - CTRL for antenna swirch. GPIOC_13 nCTRL or VDD, at this moment it just turned to 1.

#define RADIO_ANT_SWITCH_PWR_PORT                 GPIOC
#define RADIO_ANT_SWITCH_PWR_PIN                  GPIO_PIN_13 // GPIOC_13 nCTRL or VDD, at this moment it just turned to 1.
